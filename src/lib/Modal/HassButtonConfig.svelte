<script lang="ts">
	...
	import { updateObj, getName, getTogglableService, getDomain } from '$lib/Utils';
...
{#if isOpen}
	<Modal>
		<h1 slot="title">Hass Button</h1>

		<h2>{$lang('preview')}</h2>

		<div style:pointer-events="none">
			<HassButton {sel} {sectionName} />
		</div>
		...
		<div style="display: flex; gap: 0.8rem;">
			<input
				...
				type="text"
				placeholder={servicePlaceholder || $lang('service')}
				disabled={true}
			/>
